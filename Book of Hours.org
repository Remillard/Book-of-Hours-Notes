...
See [[*Element of Soul Card Table]] in the appendix for details.
...
See [[*Memory Table]] for details on the traits of known memories.

See [[*Weather Table]] for details on the traits of weather memories.
...
See [[*Book Table]] for a listing of which lessons and other memories are obtained
from which books.  This may be cross-referenced with the [[*Memory Table]] for
properties of specific memories.
...
See [[*Weather Table]] for information on which seasons may produce which weather
memories.
...
the element challenge and cycling through the bonus rounds.  (See [[*Books]] for
more details.)
...
See [[*Weather Table]] for full details on weather memory cards.
...
See [[*Tree of Wisdom]] for details about the branches, and see [[*Skills Table]] for
information about the known skills, stats, and potential branch alignments and
the element of soul cards produced..
...
See [[*Crafting Items Summary Table]] and [[*Craftable Items Tables]] for information
about craftable individual items.

See [[*Miscellaneous Items]] for tables associated with many of the household
...
note are further discussed in [[*Inventory Items]].
...
helper (see [[*Brancrug Village]]) or by visitors in search of consultation or in
...
- Challenge: To obtain a lessons from the book, a soul principle challenge must
  ...
  - If the initial cards for the challenge does not satisfy the requirements,
    ...
    generated (See [[*Mood Table]] for details on what principles are covered
    with which moods.)  Wall art and weather are notable items that may be
    requested.
  ...
  - Any Element card used in the challenge attempt will gain the /Fatigued/
    trait for the rest of the day.
...
See [[*Book Table]] for details about known books.
...
See [[*Town Assistant Table]] and [[*Hired Assistant Table]] for details on the
assistant hiring requirements and soul principle capabilities.
...
See [[*Skills Table]] for the list of skills and the soul cards that result from
...
- Gregory Wheelock
  - Employed by Walter Dewulf to construct the Winding Stair and gues chambers.
...
| Unhatched Hymns                           | 10 lantern | Sabazine | Sacra Solis Invicti             |                     |    4 |
|-------------------------------------------+------------+----------+---------------------------------+---------------------+------|
...
Organized by position in the [[*Tree of Wisdom]] starting at the top and working
...
See [[*Craftable Items]] for details on the results of crafting.

|-----------------------+------------------+-----------------------+---------------+---------------+----------------|
| Craftable             | Priciple Req.    | Skill                 | Special       | Type          | Notes          |
|-----------------------+------------------+-----------------------+---------------+---------------+----------------|
| Westcott's Compounds  | 5 moth           |                       |               | Material      |                |
| Isle-Water Pitcher    | 1 heart, 1 penny |                       |               | Beverage      | At Well        |
| Witching Tisane       | 5 grail          |                       |               | Beverage      |                |
| Thirza's Cordials     | 5 nectar         |                       |               | Beverage      |                |
| Bitterblack Salts     | 5 forge          |                       |               | Pigment       |                |
| Refulgin              | 5 lantern        |                       |               | Pigment       |                |
| Salt-sign             | 5 rose           |                       |               | Mark          |                |
| Midnight Mark         | 5 moon           |                       |               | Mark          |                |
| Torgue's Cleansing    | 5 edge / 5 sky   |                       |               | Memory        |                |
| Secret Threshold      | 5 knock          |                       |               | Memory        |                |
| Bittersweet Certainty | 5 winter         |                       |               | Memory        | Desk:Eva       |
| Iotic Essence         | 10 forge         | Anbary & Lapidary     | Liquid        | Pigment, Fuel | Alchemy Table  |
| Orpiment Exultant     | 15 forge         | Anbary & Lapidary     | Iotic Essence | Ink           | Alchemy Table  |
| Curious Hunch         | 10 knock         | The Great Signs/Scars | Memory        | Memory        | Necropsy Table |
|-----------------------+------------------+-----------------------+---------------+---------------+----------------|
...
| Trumpeter's Lily   | 1 heart, 1 nectar, 2 skyf            | Physic Garden          | Summer         |
...
| Blue Crown         | 1 nectar, 2 sky, 2 winter            | St Brandan's Cloister  | Winter         |
| Lenten Rose        | 1 grail, 1 nectar, 2 rose            | Scent Garden           | Winter         |
| Pyrus Auricalcinus | 4 forge, 4 nectar                    | Scent Garden           | /Numa/           |
| Aglaophotis        | 2 knock, 2 lantern, 1 nectar, 2 rose | Physic Garden          | /Numa/           |
|--------------------+--------------------------------------+------------------------+----------------|
...
| Snootle Jar              | Motley Tower: Dispensary               | 1 flantern, 1 moth                 |
...
| Granite Slab             | 1 forge, 1 scale  |      | Touch  | Yes        |
|--------------------------+-------------------+------+--------+------------|
